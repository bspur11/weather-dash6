$(document).ready(function () {
    ...
    //grab item from local storage, if any.
    ...
    function weatherFunction(searchTerm) {
        ...
        $.ajax({
            type: "GET",
            url: "https://pro.openweathermap.org/data/2.5/forecast/hourly?q=" + searchTerm + "&appid=baadb8b3c155d192317c8b8f3b3d1729&units=metric",
            ...
            var wind = $("<p>").addClass("card-text").text("Wind Speed: " + data.wind.speed + " KPH");
            ...
            $.ajax({
                type: "GET",
                url: "https://api.openweathermap.org/data/2.5/uvi?appid=baadb8b3c155d192317c8b8f3b3d1729&lat=" + lat + "&lon=" + lon,
    ...
    function weatherForecast(searchTerm) {
        $.ajax({
            type: "GET",
            url: "https://api.openweathermap.org/data/2.5/forecast?q=" + searchTerm + "&appid=baadb8b3c155d192317c8b8f3b3d1729&units=metric",
            ...
            for (var i = 0; i < data.list.length; i++) {
                ...
                if (data.list[i].dt_txt.indexOf("15:00:00") !== -1) {
                    ...
                    var tempFive = $("<p>").addClass("card-text").text("Temperature: " + data.list[i].main.temp + " °C");
